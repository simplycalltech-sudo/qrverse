...
function App() {
  ...
  const [qrSize, setQrSize] = useState(900); // default preset
  const [logoFile, setLogoFile] = useState(null); // placeholder for future logo
      ...
      <main className="app-main">
        <div className="main-container">
          ...
          <section className="section customization-section">
            ...
            <p className="section-subtitle">
              Adjust colors and size, or upload a logo (coming soon).
            </p>
